...
import type { LiveLead } from '../lib/live-crm';
import { Avatar, ScoreBadge, StageBadge } from './crm-components';
type FunnelStage = LiveLead['stage'];
...
export function LeadTable({ leads }: Readonly<{ leads: readonly LiveLead[] }>) {
...
function LeadTableRow({ lead }: Readonly<{ lead: LiveLead }>) {
